    ...
    <div className="flex flex-col items-center max-w-screen-xl h-[calc(100vh-64px)]">
      ...
      {totalAmount && totalAmount > 0 ? (
        <section className="flex justify-center">
          <ProductList className="flex flex-col items-end overflow-y-scroll w-[42vw]">
            ...
            <>
              ...
              <div className="text-xl font-semibold rounded-lg bg-white p-5 w-80 my-4">
                ...
                <div className="flex text-sm font-semibold ">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp; Proteção ao cliente Recupere o seu reembolso se o artigo
                  não for entregue ou de acordo com a descrição.
                </div>
              </div>
            </>
          </div>
